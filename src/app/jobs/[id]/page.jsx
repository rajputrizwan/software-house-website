...
export default function JobDescription() {
    ...
    return (
        <div className="max-w-4xl mt-20 mx-auto py-12 px-6 bg-white dark:bg-gray-900 rounded-xl shadow-lg transition-colors">
            {/* Title */}
            ...
            <Link
                href={`/jobs/${id}/apply`}
                className="bg-green-700 dark:bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-800 dark:hover:bg-green-700 transition"
            >
                Apply Now
            </Link>
        </div>
