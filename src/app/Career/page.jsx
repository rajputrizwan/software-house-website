...
export default function CareersPage() {
  ...
  const InfiniteScrollRow = ({ images, direction = "left", speed = 0.5 }) => {
    ...
    const scrollImages =
      direction === "right" ? [...images].reverse() : images;
  ...
  return (
    <div className="w-full">
      {/* Hero Header */}
      <motion.header
        className="relative flex items-center justify-center text-center text-white dark:text-white mt-20"
      ...
      >
        ...
        >
          ...
          <p className="mb-6">
            We’re more than a workplace—we’re a people-first community that grows
            stronger together.
          </p>
          <Link
            href="/jobs"
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold mb-12">
            ...
            <span className="text-blue-600">escStack</span>
          </h2>
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="max-w-full mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-12 text-2xl">
            Your Growth, Our Priority. At escStack, we provide a clear and rewarding
            path to help you achieve your professional aspirations.
          </p>
        ...
        >
          ...
          <section className="py-20 bg-black dark:bg-gray-800 text-white">
              <div className="text-center mb-10 px-4">
                  <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold">Culture & Lifestyle</h2>
              ...
              <div className="flex-1 text-center lg:text-left">
                  ...
                  <ul className="space-y-3 sm:space-y-4 text-base sm:text-lg font-light leading-relaxed">
                      {benefits.map((benefit, idx) => (
                          <li
                              key={idx}
                              className={`cursor-pointer hover:text-blue-400 transition-colors duration-300 ${activeIndex === idx ? "text-blue-300 font-semibold" : ""
                                  }`}
