...
function ServicesPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-black dark:text-white transition-colors duration-300 mt-10">
      <h1>Services Page</h1>
      <p>
        ...
        want from the different galleries. Themes and styles also help keep your
        ...
        When you apply styles, your headings change to match the new theme. Save
        time in Word with new buttons that show up where you need them. To
